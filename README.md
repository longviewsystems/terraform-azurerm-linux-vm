...
| <a name="input_SRId"></a> [SRId](#input\_SRId) | This is the Order ID of the Service Request to build the Azure Resource. | `string` | `""` | no |
...
| <a name="input_backup_vault_name"></a> [backup\_vault\_name](#input\_backup\_vault\_name) | The backup policy to be assigned to the virtual machine. | `string` | `""` | no |
...
| <a name="input_os_disk_disk_size_gb"></a> [os\_disk\_disk\_size\_gb](#input\_os\_disk\_disk\_size\_gb) | The size of the OS disk. | `string` | `"100"` | no |
